...
game: main.o iGraphics.o keyboard.o mouse.o grid.o draw.o point.o color.o object.o circle.o bird.o image_render.o box.o pipe.o game_details.o score_font.o
	g++32  -LOpengl\\lib  main.o iGraphics.o grid.o keyboard.o mouse.o draw.o point.o color.o object.o circle.o bird.o  pipe.o image_render.o box.o game_details.o score_font.o -o game -lfreeglut -lGlaux -lopengl32 -lglu32 -lwinmm -lgdi32 -static-libgcc -static-libstdc++ 
